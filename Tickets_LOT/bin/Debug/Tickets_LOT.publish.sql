...
SET @CountryId = (SELECT TOP (1) ID FROM [DESKTOP-3TDOV04\SQLEXPRESS].Airports.Countries WHERE Countries.Iso LIKE @PassengerCountryOfResidence)
...
INSERT INTO [DESKTOP-3TDOV04\SQLEXPRESS].Airports.BookedFlightSegments (TicketId, FlightSegmentId) VALUES (@TicketId, @FlightSegmentId1);
...
INSERT INTO Discounts (DiscountPercentage) VALUES (20);
GO
