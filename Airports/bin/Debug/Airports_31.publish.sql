...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL14.SQLDEV1\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL14.SQLDEV1\MSSQL\DATA\"
...
CREATE TABLE [dbo].[BookedFlightSegments] (
    ...
    CONSTRAINT [PK_BookedFlightSegments] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
PRINT N'Creating [dbo].[TicketId]...';


GO
CREATE SEQUENCE [dbo].[TicketId]
    AS BIGINT
    START WITH 1
    INCREMENT BY 1
    CACHE 10;
...
GO
PRINT N'Creating [dbo].[FindNumberOfPassengersForFlight]...';
...
GO
PRINT N'Creating [dbo].[FindTicketByPassenger]...';
...
GO
PRINT N'Creating [dbo].[GetNextTicketId]...';
...
AS
	SELECT NEXT VALUE FOR [dbo].[TicketId];
GO
SET ANSI_NULLS, QUOTED_IDENTIFIER ON;
