...
SET @DiscountPercentage = (SELECT TOP (1) DiscountPercentage FROM Discounts WHERE CountryId = @CountryId);
...
INSERT INTO Discounts (CountryId, DiscountPercentage) VALUES (226, 20);
