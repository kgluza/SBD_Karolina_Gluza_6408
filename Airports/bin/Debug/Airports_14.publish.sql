...
ALTER TABLE [dbo].[Flights]
    ADD FOREIGN KEY ([From]) REFERENCES [dbo].[Airports] ([Id]);
...
GO
ALTER TABLE [dbo].[Flights]
    ADD FOREIGN KEY ([To]) REFERENCES [dbo].[Airports] ([Id]);
...
SELECT 
	...
	AirportFrom.Code AS FromAirportCode,
	AirportFrom.Name AS FromAirportName,
	AirportTo.Code AS ToAirportCode,
	AirportTo.Name AS ToAirportName,
	Flights.Departure,
	Flights.Arrival
  FROM [Airports].[dbo].[Tickets]
  ...
  INNER JOIN Airports AS AirportFrom ON AirportFrom.Id =  [Flights].[From]
  INNER JOIN Airports AS AirportTo ON AirportTo.Id =  [Flights].[To]
