...
CREATE PROCEDURE [dbo].BookTicket
    ...
    @FlightSegmentId2 int,
    @FlightSegmentId3 int,
    @FlightSegmentId4 int
AS
DECLARE @CountryId int;
DECLARE @DiscountPercentage int = 0;
DECLARE @TicketId int;

SET @CountryId = (SELECT TOP (1) ID FROM Countries WHERE Countries.Iso = @PassengerCountryOfResidence)
...
IF (@FlightSegmentId1 IS NULL)
    THROW 50001, 'Ticket must contain at least one segment', 1;
